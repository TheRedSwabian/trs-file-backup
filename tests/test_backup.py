...
class TestFileOperations:
    ...
    def test_generate_backup_filename_with_path(self):
    ...
    def test_matches_exclusion_pattern_exact_match(self):
    ...
    def test_matches_exclusion_pattern_wildcard(self):
    ...
    def test_matches_exclusion_pattern_hidden_files(self):
    ...
    def test_get_files_to_backup_all_new_files(self, mocker):
    ...
    def test_get_files_to_backup_excludes_directories(self, mocker):
    ...
    def test_get_files_to_backup_applies_exclusion_patterns(self, mocker):
    ...
    def test_get_files_to_backup_only_modified(self, mocker):
    ...
    def test_backup_file_copies_file(self, mocker):
    ...
    def test_backup_file_creates_destination_dir(self, mocker):
    ...
    def test_backup_file_handles_permission_error(self, mocker):
        """Test that backup_file handles permission errors gracefully."""
        from trs_file_backup.backup import BackupManager

        mock_copy = mocker.patch("shutil.copy2", side_effect=PermissionError("Access denied"))
        mock_mkdir = mocker.patch("pathlib.Path.mkdir")
    ...
    def test_backup_file_handles_locked_file(self, mocker):
        """Test that backup_file handles locked files (OSError)."""
        from trs_file_backup.backup import BackupManager

        mock_copy = mocker.patch("shutil.copy2", side_effect=OSError("File is locked"))
        mock_mkdir = mocker.patch("pathlib.Path.mkdir")
